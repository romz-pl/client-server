...
#include <arpa/inet.h> /* for soekaddr_in and inet_ntoa() */
#include <stdlib.h>
#include <string.h>
#include <unistd.h>
#include <fcntl.h>
...
void SIGIOHandler(int signalType); /* Function to handle SlGIO */
...
void SIGIOHandler( int signalType )
{
    ...
    ssize_t recvMsgSize; /* Size of datagram */
    ...
    do /* As long as there is input... */
    {
        ...
        else
        {
            ...
            if( sendto( sock, echoBuffer, (size_t)recvMsgSize, 0, (struct sockaddr *)&echoClntAddr, sizeof( echoClntAddr ) ) != recvMsgSize )
